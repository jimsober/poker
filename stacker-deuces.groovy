        ...
        if (input.trim() == '') {
            ...
            try {
                ...
                try {
                    ...
                    try {
                        assert input.toInteger() <= 10000
                        input_err = false
                        num_hands = input.toInteger()
                    } catch (AssertionError e) {
                            println 'Number of hands cannot be greater than the house limit (10000).' + '\7'
                            num_hands = 10000
                    }
                } catch (AssertionError e) {
...
def no_deuces(List hand) {
    ...
    //four of a straight
    else if (deuceless_rank_vals.size() == 5 && deuceless_rank_vals.sort()[0..3] in [[3,4,5,14],[3,4,5,7],[3,4,6,7],\
      [3,5,6,7],[4,5,6,8],[4,5,7,8],[4,6,7,8],[5,6,7,9],[5,6,8,9],[5,7,8,9],[6,7,8,10],[6,7,9,10],[6,8,9,10],\
      [7,8,9,11],[7,8,10,11],[7,9,10,11],[8,9,10,12],[8,9,11,12],[8,10,11,12],[9,10,11,13],[9,10,12,13],[9,11,12,13],\
      [10,11,12,14],[10,11,13,14],[10,12,13,14]]) {
    ...
    else if (deuceless_rank_vals.size() == 5 && deuceless_rank_vals.sort()[1..4] in [[3,4,5,14],[3,4,5,7],[3,4,6,7],\
      [3,5,6,7],[4,5,6,8],[4,5,7,8],[4,6,7,8],[5,6,7,9],[5,6,8,9],[5,7,8,9],[6,7,8,10],[6,7,9,10],[6,8,9,10],\
      [7,8,9,11],[7,8,10,11],[7,9,10,11],[8,9,10,12],[8,9,11,12],[8,10,11,12],[9,10,11,13],[9,10,12,13],[9,11,12,13],\
      [10,11,12,14],[10,11,13,14],[10,12,13,14]]) {
        hold_hand = wild_cards.collect()
